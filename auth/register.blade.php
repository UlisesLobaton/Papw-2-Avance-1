        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!--<form method="POST" action="/trainers" class="form-group" enctype="multipart/form-data">-->
                        @csrf
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ __('Nickname') }}</label>

                            <div class="col-md-6">
                                <input id="slug" type="text" class="form-control" name="slug" required autocomplete="slug">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="avatar" type="file" class="form-control" name="avatar" required autocomplete="avatar">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cover" type="file" class="form-control" name="cover" required autocomplete="cover">
                            </div>
                        </div>
